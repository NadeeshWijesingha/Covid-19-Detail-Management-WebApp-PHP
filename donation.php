        ...
        <div class="container" style="padding: 40px 15px;">
            <div class="row" style="padding: 25px;">
                <div class="col" style="padding: 0px 15px;">
                    <h1 style="padding: 0px;height: 65px;filter: blur(0px);">Help us to do more</h1>
                    <p style="font-family: Alatsi, sans-serif;">To bring about a better future, we need data and research to understand the big problems the world is facing and how to make progress against them. That’s why we make all our work free and accessible for everyone.<br><br>We are a nonprofit.
                        This means we rely on donations and grants to keep us going. Reader donations are essential to our work, providing us with the stability and independence we need, so we can focus on showing the data and evidence we think everyone
                        needs to know.<br><br>Donating is also one way to show us that you find our work helpful and valuable. Knowing this is a huge source of inspiration for our team.<br><br>If you want to help us do more, please donate today – it will
                        make a real difference.<br><br>Thank you,<br>Global Change Data Lab and the Our World in Data team<br><br></p>
                    <hr>
                    <p><a href="https://ourworldindata.org/about">About us</a>&nbsp;–&nbsp;<a href="https://ourworldindata.org/uploads/2019/02/Donations-Policy-Global-Change-Data-Lab.pdf">Donations Policy</a>&nbsp;–&nbsp;<a href="https://ourworldindata.org/donate/faq">Donations FAQ</a><br></p>
                </div>
            </div>
        </div>
    </main>
