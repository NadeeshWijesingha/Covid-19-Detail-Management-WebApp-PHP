...
<body>
    ...
    <?php require_once'hos_controller_helper.php'?>
    ...
    <div class="container" style="padding: 10px;box-shadow: 0px 0px 15px 1px;border-radius: 10px;margin-top: 20px;margin-bottom: 20px;">
        <section>
            <h1 class="text-center text-capitalize" style="font-family: Archivo, sans-serif;">Hospital</h1>
            <div class="container" style="padding: 10px;">
                <form action="hos_controller_helper.php" method="POST">
                    ...
                    <div class="form-group"><input class="form-control" type="number" name="newcase" placeholder="New Cases" required='true' pattern="^\d*(\.\d{0,2})?$" title="You can only enter integers. . !"></div>
                    <div class="form-group"><input class="form-control" type="number" name="death" placeholder="Deaths" required='true' pattern="^\d*(\.\d{0,2})?$" title="You can only enter integers. . !"></div>
                    <div class="form-group"><input class="form-control" type="number" name="recover" placeholder="Recovered" required='true' pattern="^\d*(\.\d{0,2})?$" title="You can only enter integers. . !"></div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="background: rgb(0,0,0);">New Cases</th>
                        <th class="text-center" style="background: rgb(0,0,0);">Deaths</th>
                        <th class="text-center" style="background: rgb(0,0,0);">Recovered</th>
...
<?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo$row['new_case'];?></td>
                        <td class="text-center"><?php echo$row['death'];?></td>
                        <td class="text-center"><?php echo$row['recover'];?></td>
                        <td class="text-center">

                        <a href="hos_controller.php?delete=<?php echo $row['hos_update_id']; ?>" class="btn btn-danger">Delete</a>             
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-8 mx-auto">
                    ...
                    <p class="copyright text-muted text-center">Copyright &copy; Nadeeshan Wijesingha | 2020</p>
                </div>
            </div>
        </div>
    </footer>
