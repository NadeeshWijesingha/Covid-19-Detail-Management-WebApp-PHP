...
<?php require_once'world_controller_helper.php'?>
...
<body>
    ...
    <div class="container" style="padding: 10px;box-shadow: 0px 0px 15px 1px;border-radius: 10px;margin-top: 20px;margin-bottom: 20px;">
        <section>
            <h1 class="text-center text-capitalize" style="font-family: Archivo, sans-serif;">World</h1>
            <div class="container" style="padding: 10px;">
                <form action="world_controller_helper.php" method="POST">
    ...
    <div class="container" style="padding: 10px;border-radius: 10px;box-shadow: 0px 0px 15px;margin-bottom: 12.8px;">
        <div id="world_table" class="datagrid">
            <table class="table">
                <thead>
                    <tr>
...
<?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <a href="world_controller.php?delete=<?php echo $row['world_update_id']; ?>" class="btn btn-danger">Delete</a>             
